...
// string concatentaion takes prescedence over addition

// 4.string concatenation - combines strings together
...
// slice whenever you want to get substring from a given String
// startIndex - inclusive
// endIndex - exclusive

// Variables are declared with either let or const keywords:
...
// var   ES5 older, more loose syntax
// let   ES6 variables declared with let keywords can be reassigned (=)
// const ES6 variables declared with const keyword can not be reassigned (=)

// = assignment / re- assignment 
// === equality; when we want to check if something is equal

// let string = "bootcamp prep"

// console.log(string === "bootcamp prep");  true

// Good variable naming conventions:


// conditionals:
// If the expression evaluate to a "truthy" value,
...
//Falsey values: JavaScript falsey values 
...
console.log(!false)
console.log(!NaN)
// ! converts it from true to false, false to true (makes it opposite)

// explicit
// implicit = undefined, NaN, null
